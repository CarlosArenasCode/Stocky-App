...
Control de inventario y ventas simplificado para negocios locales. Alternativa eficiente a las hojas de cálculo manuales.

## Estado del repositorio

Por ahora, este repositorio contiene la **documentación de producto** (visión, alcance MVP, backlog y Definition of Done). La implementación (stack, arquitectura y código) aún no está inicializada.
